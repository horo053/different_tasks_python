#2. На вход программе подается целое положительное число N. Необходимо написать рекурсивную функцию с именем get_rec_N,
...
# Начальный вызов функции уже дан в программе и выглядит так: get_rec_N(N)
def get_rec_N(n):
    if n > 1:
         get_rec_N(n-1)
    print(n)
