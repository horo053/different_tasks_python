#9.1. Выведите в консоль название дня недели последнего дня текущего месяца.
import datetime
import calendar
def lastDayInMonth():
...
#9.2. Дана строка с текстом. Получите процентное
...
#9.3. Дана некоторая строка с числом: '1234567'
